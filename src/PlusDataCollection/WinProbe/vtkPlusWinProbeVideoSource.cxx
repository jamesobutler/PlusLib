...
PlusStatus vtkPlusWinProbeVideoSource::SetExtraSourceMode(Mode mode)
{
  ...
  else if(mode == Mode::ARFI)
  {
    ...
    SetDigitalGain(7);
    SetADCACTIVE_TERMINATION_ENABLE(true);
    SetADCPRESET_ACTIVE_TERMINATION(0);
    SetADCACTIVE_TERMINATION_INDIVIDUAL_RESISTOR_ENABLE(true);
    SetADCACTIVE_TERMINATION_INDIVIDUAL_RESISTOR_CNTL(0);
    SetADCLNA_GAIN(3);
    SetADCLNA_INPUT_CLAMP_SETTING(1);
    SetADCDIGITAL_HPF_FILTER_ENABLE_CH_1_4(true);
    SetADCDIGITAL_HPF_FILTER_ENABLE_CH5_8(true);
    SetADCDIGITAL_HPF_FILTER_K_CH5_8(15);
    SetADCDIGITAL_HPF_FILTER_K_CH_1_4(15);
    SetADCHPF_LNA(2);
    SetADCPGA_CLAMP_LEVEL(0);
    SetADCPGA_GAIN_CONTROL(0);
  }
  SetPendingRecreateTables(true);
